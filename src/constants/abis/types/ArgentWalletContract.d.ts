...
export class ArgentWalletContract extends BaseContract {
  ...
  estimateGas: {
    ...
    isValidSignature(_msgHash: BytesLike, _signature: BytesLike, overrides?: CallOverrides): Promise<BigNumber>
  }
  ...
  populateTransaction: {
    ...
    isValidSignature(_msgHash: BytesLike, _signature: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>
  }
}
