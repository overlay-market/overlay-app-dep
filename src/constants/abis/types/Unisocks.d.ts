...
export class Unisocks extends BaseContract {
  ...
  functions: {
    tokenURI(_tokenId: BigNumberish, overrides?: CallOverrides): Promise<[string] & {out: string}>
    ...
    changeMinter(_minter: string, overrides?: Overrides & {from?: string | Promise<string>}): Promise<ContractTransaction>

    changeURI(_newURI: string, overrides?: Overrides & {from?: string | Promise<string>}): Promise<ContractTransaction>

    name(overrides?: CallOverrides): Promise<[string] & {out: string}>

    symbol(overrides?: CallOverrides): Promise<[string] & {out: string}>

    totalSupply(overrides?: CallOverrides): Promise<[BigNumber] & {out: BigNumber}>
    ...
    ownerOf(arg0: BigNumberish, overrides?: CallOverrides): Promise<[string] & {out: string}>

    balanceOf(arg0: string, overrides?: CallOverrides): Promise<[BigNumber] & {out: BigNumber}>

    getApproved(arg0: BigNumberish, overrides?: CallOverrides): Promise<[string] & {out: string}>

    isApprovedForAll(arg0: string, arg1: string, overrides?: CallOverrides): Promise<[boolean] & {out: boolean}>

    supportsInterface(arg0: BytesLike, overrides?: CallOverrides): Promise<[boolean] & {out: boolean}>
  }
  ...
  filters: {
    ...
    ): TypedEventFilter<[string, string, BigNumber], {_from: string; _to: string; _tokenId: BigNumber}>

    Approval(
      _owner?: string | null,
      _approved?: string | null,
      _tokenId?: BigNumberish | null,
    ): TypedEventFilter<[string, string, BigNumber], {_owner: string; _approved: string; _tokenId: BigNumber}>

    ApprovalForAll(
      _owner?: string | null,
      _operator?: string | null,
      _approved?: null,
    ): TypedEventFilter<[string, string, boolean], {_owner: string; _operator: string; _approved: boolean}>
  }
  ...
  estimateGas: {
    ...
    changeMinter(_minter: string, overrides?: Overrides & {from?: string | Promise<string>}): Promise<BigNumber>

    changeURI(_newURI: string, overrides?: Overrides & {from?: string | Promise<string>}): Promise<BigNumber>
  ...
  populateTransaction: {
    ...
    changeMinter(_minter: string, overrides?: Overrides & {from?: string | Promise<string>}): Promise<PopulatedTransaction>

    changeURI(_newURI: string, overrides?: Overrides & {from?: string | Promise<string>}): Promise<PopulatedTransaction>
