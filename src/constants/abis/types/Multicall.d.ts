...
interface MulticallInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'blockAndAggregate', values: [{target: string; callData: BytesLike}[]]): string
...
export class Multicall extends BaseContract {
  ...
  functions: {
    ...
    getBlockHash(
      ...
      [string, ([boolean, string] & {success: boolean; returnData: string})[]] & {
        blockHash: string
