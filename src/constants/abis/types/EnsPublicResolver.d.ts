...
export class EnsPublicResolver extends BaseContract {
  ...
  filters: {
    ...
    ): TypedEventFilter<[string, BigNumber], {node: string; contentType: BigNumber}>

    AddrChanged(node?: BytesLike | null, a?: null): TypedEventFilter<[string, string], {node: string; a: string}>

    AddressChanged(
      node?: BytesLike | null,
      coinType?: null,
      newAddress?: null,
    ): TypedEventFilter<[string, BigNumber, string], {node: string; coinType: BigNumber; newAddress: string}>
    ...
    DNSRecordChanged(
      ...
      resource?: null,
      record?: null,
    ): TypedEventFilter<[string, string, number, string], {node: string; name: string; resource: number; record: string}>

    DNSRecordDeleted(
      node?: BytesLike | null,
      name?: null,
      resource?: null,
    ): TypedEventFilter<[string, string, number], {node: string; name: string; resource: number}>

    DNSZoneCleared(node?: BytesLike | null): TypedEventFilter<[string], {node: string}>

    InterfaceChanged(
      node?: BytesLike | null,
      interfaceID?: BytesLike | null,
      implementer?: null,
    ): TypedEventFilter<[string, string, string], {node: string; interfaceID: string; implementer: string}>
    ...
    TextChanged(
      ...
      key?: null,
    ): TypedEventFilter<[string, string, string], {node: string; indexedKey: string; key: string}>
  }
