...
interface ArgentWalletDetectorInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'acceptedCodes', values: [BytesLike]): string
  encodeFunctionData(functionFragment: 'acceptedImplementations', values: [string]): string
  encodeFunctionData(functionFragment: 'addCode', values: [BytesLike]): string
  encodeFunctionData(functionFragment: 'addCodeAndImplementationFromWallet', values: [string]): string
  ...
  encodeFunctionData(functionFragment: 'isArgentWallet', values: [string]): string
...
export class ArgentWalletDetector extends BaseContract {
  ...
  functions: {
    ...
    changeOwner(_newOwner: string, overrides?: Overrides & {from?: string | Promise<string>}): Promise<ContractTransaction>
  ...
  callStatic: {
    ...
    addCodeAndImplementationFromWallet(_argentWallet: string, overrides?: CallOverrides): Promise<void>
  ...
  filters: {
    CodeAdded(code?: BytesLike | null): TypedEventFilter<[string], {code: string}>

    ImplementationAdded(implementation?: string | null): TypedEventFilter<[string], {implementation: string}>

    OwnerChanged(_newOwner?: string | null): TypedEventFilter<[string], {_newOwner: string}>
  }

  estimateGas: {
    acceptedCodes(arg0: BytesLike, overrides?: CallOverrides): Promise<BigNumber>

    acceptedImplementations(arg0: string, overrides?: CallOverrides): Promise<BigNumber>
    ...
    changeOwner(_newOwner: string, overrides?: Overrides & {from?: string | Promise<string>}): Promise<BigNumber>

    getCodes(overrides?: CallOverrides): Promise<BigNumber>

    getImplementations(overrides?: CallOverrides): Promise<BigNumber>

    isArgentWallet(_wallet: string, overrides?: CallOverrides): Promise<BigNumber>

    owner(overrides?: CallOverrides): Promise<BigNumber>
  }

  populateTransaction: {
    acceptedCodes(arg0: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>

    acceptedImplementations(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>

    addCode(_code: BytesLike, overrides?: Overrides & {from?: string | Promise<string>}): Promise<PopulatedTransaction>
    ...
    isArgentWallet(_wallet: string, overrides?: CallOverrides): Promise<PopulatedTransaction>
