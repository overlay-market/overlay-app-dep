    ...
    <>
      {isMobile ? (
        <>
          ...
          <ReactTooltip place="bottom" type="info" effect="solid" textColor={color} id={mobileDataTip} globalEventOff="click">
        ...
        <>
          ...
          <ReactTooltip place="bottom" type="info" effect="solid" textColor={color} id={desktopDataTip}>
            <TipContainer>{children}</TipContainer>
          </ReactTooltip>
        </>
      )}
