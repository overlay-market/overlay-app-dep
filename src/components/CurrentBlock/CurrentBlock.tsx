...
const StyledPollingNumber = styled(TEXT.Supplemental)<{
  breathe: boolean
  hovering: boolean
}>`
...
export default function CurrentBlock() {
  ...
  useEffect(
    () => {
      ...
      // this will clear Timeout when component
      // unmount like in willComponentUnmount
      return () => {
        clearTimeout(mountingTimer)
      }
    },
    [blockNumber], // useEffect will run only one time
    // if you pass a value to array, like this [data] than clearTimeout will
    // run every time this value changes (useEffect re-run)
  )
