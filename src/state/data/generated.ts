  ...
  account?: Maybe<
    {__typename?: 'Account'} & {
      positions: Array<
        ...
        > & {market: {__typename?: 'Market'} & Pick<Market, 'id' | 'feedAddress'>}
      >
      builds: Array<{__typename?: 'Build'} & Pick<Build, 'id'>>
      unwinds: Array<{__typename?: 'Unwind'} & Pick<Unwind, 'id'>>
      liquidates: Array<{__typename?: 'Liquidate'} & Pick<Liquidate, 'id'>>
    }
  >
}
...
export type MarketQuery = {__typename?: 'Query'} & {
  market?: Maybe<
    {__typename?: 'Market'} & Pick<
      ...
      | 'averageBlockTime'
      | 'isShutdown'
    > & {factory: {__typename?: 'Factory'} & Pick<Factory, 'id'>}
  >
}
...
export type MarketsQuery = {__typename?: 'Query'} & {
  markets: Array<
    {__typename?: 'Market'} & Pick<Market, 'id' | 'feedAddress' | 'capNotional'> & {
        positions: Array<{__typename?: 'Position'} & Pick<Position, 'id'>>
      }
  >
}
...
export type PositionsQuery = {__typename?: 'Query'} & {
  positions: Array<
    {__typename?: 'Position'} & Pick<Position, 'id' | 'positionId' | 'isLiquidated'> & {
...
const injectedRtkApi = api.injectEndpoints({
  endpoints: build => ({
    ...
    activeMarkets: build.query<MarketsQuery, MarketsQueryVariables | void>({
