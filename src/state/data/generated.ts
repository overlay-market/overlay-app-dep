...
export type MarketsQuery = (
  ...
  & { markets: Array<(
    { __typename?: 'Market' }
    & Pick<Market, 'id' | 'oiLong' | 'oiShort' | 'capNotional'>
    & { positions: Array<(
      { __typename?: 'Position' }
      & Pick<Position, 'id'>
    )> }
...
export const { useAccountQuery, useLazyAccountQuery, useMarketQuery, useLazyMarketQuery, useMarketsQuery, useLazyMarketsQuery } = injectedRtkApi;
